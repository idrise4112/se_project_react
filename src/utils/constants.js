...
export const defaultWeatherOptions = {
  day: { url: new URL("../assets/day/default1.png", import.meta.url).href },
...
// Clean BASE_URL logic
export const BASE_URL =
  process.env.NODE_ENV === "production"
    ? "https://api.wtwfrontendd.strangled.net"
    : "http://localhost:3001";
...
export const APIkey = "becc11aea0638cb77d0884f098e7afce";
